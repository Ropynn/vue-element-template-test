var CityInfo = [
  { value: 110000, label: '北京', children: [
    { value: 110100, label: '北京市', children: [
      ...
      { value: 110118, label: '密云县' },
      { value: 110119, label: '延庆县' }
    ] }
  ] },
  ...
  { value: 130000, label: '河北', children: [
    ...
    { value: 130600, label: '保定市', children: [
      ...
      { value: 130606, label: '北市区' },
      { value: 130603, label: '南市区' },
      { value: 130607, label: '满城区' },
      { value: 130608, label: '清苑县' },
  ...
  { value: 150000, label: '内蒙古', children: [
    ...
    { value: 152200, label: '兴安盟', children: [
    ...
    { value: 152900, label: '阿拉善盟', children: [
  ...
  { value: 320000, label: '江苏', children: [
    ...
    { value: 320400, label: '常州市', children: [
      ...
      { value: 320413, label: '金坛市' },
      { value: 320481, label: '溧阳市' }
    ] },
    { value: 320500, label: '苏州市', children: [
      { value: 320502, label: '沧浪区' },
      { value: 320503, label: '平江区' },
      { value: 320504, label: '金阊区' },
    ...
    { value: 320800, label: '淮安市', children: [
      ...
      { value: 320805, label: '清河区' },
      { value: 320806, label: '楚州区' },
  ...
  { value: 340000, label: '安徽', children: [
    ...
    { value: 340200, label: '芜湖市', children: [
      ...
      { value: 340204, label: '马塘区' },
      { value: 340205, label: '新芜区' },
    ...
    { value: 341400, label: '巢湖市', children: [
      { value: 341401, label: '居巢区' },
      { value: 341402, label: '庐江县' },
      { value: 341403, label: '无为县' },
      { value: 341404, label: '含山县' },
      { value: 341405, label: '和县' }
    ] },
  ...
  { value: 370000, label: '山东', children: [
    ...
    { value: 371200, label: '莱芜市', children: [
    ...
    { value: 371600, label: '滨州市', children: [
      ...
      { value: 371603, label: '沾化县' },
      { value: 371625, label: '博兴县' },
      { value: 371626, label: '邹平县' }
    ] },
    { value: 371700, label: '荷泽市', children: [
  ...
  { value: 420000, label: '湖北', children: [
    ...
    { value: 429021, label: '神农架', children: [
  ...
  { value: 430000, label: '湖南', children: [
    ...
    { value: 433100, label: '湘西', children: [
  ...
  { value: 440000, label: '广东', children: [
    ...
    { value: 441700, label: '阳江市', children: [
      ...
      { value: 441704, label: '阳西县' },
      { value: 441721, label: '阳东县' },
  ...
  { value: 500000, label: '重庆', children: [
    { value: 500100, label: '重庆市', children: [
      ...
      { value: 500110, label: '綦江县' },
      { value: 500152, label: '潼南县' },
      { value: 500151, label: '铜梁县' },
      { value: 500111, label: '大足县' },
      { value: 500153, label: '荣昌县' },
      { value: 500120, label: '璧山县' },
      ...
      { value: 500116, label: '江津市' },
      { value: 500117, label: '合川市' },
      { value: 500118, label: '永川市' },
      { value: 500119, label: '南川市' }
    ] }
  ] },
  { value: 510000, label: '四川', children: [
    ...
    { value: 512000, label: '资阳市', children: [
      ...
      { value: 512023, label: '简阳市' }
    ] },
    { value: 513200, label: '阿坝', children: [
    ...
    { value: 513400, label: '凉山', children: [
  ...
  { value: 520000, label: '贵州', children: [
    ...
    { value: 520600, label: '铜仁地区', children: [
      ...
      { value: 520603, label: '万山特区' }
    ] },
    { value: 522300, label: '黔西', children: [
    ...
    { value: 520500, label: '毕节地区', children: [
    ...
    { value: 522600, label: '黔东', children: [
    ...
    { value: 522700, label: '黔南', children: [
  ...
  { value: 530000, label: '云南', children: [
    ...
    { value: 532300, label: '楚雄', children: [
    ...
    { value: 532600, label: '文山', children: [
      { value: 532601, label: '文山县' },
    ...
    { value: 533100, label: '德宏', children: [
    ...
    { value: 533300, label: '怒江', children: [
      { value: 533301, label: '泸水县' },
      { value: 533323, label: '福贡县' },
      { value: 533324, label: '贡山独龙族怒族自治县' },
      { value: 533325, label: '兰坪白族普米族自治县' }
    ] },
    { value: 533400, label: '迪庆', children: [
      { value: 533401, label: '香格里拉县' },
  ...
  { value: 540000, label: '西藏', children: [
    { value: 540100, label: '拉萨市', children: [
      ...
      { value: 540103, label: '堆龙德庆县' },
      { value: 540126, label: '达孜县' },
      { value: 540127, label: '墨竹工卡县' }
    ] },
    { value: 540300, label: '昌都地区', children: [
    ...
    { value: 540500, label: '山南地区', children: [
      { value: 540502, label: '乃东县' },
    ...
    { value: 540200, label: '日喀则地区', children: [
    ...
    { value: 542500, label: '阿里地区', children: [
    ...
    { value: 540400, label: '林芝地区', children: [
  ...
  { value: 610000, label: '陕西', children: [
    ...
    { value: 610600, label: '延安市', children: [
      ...
      { value: 610603, label: '安塞县' },
      { value: 610625, label: '志丹县' },
      { value: 610626, label: '吴旗县' },
  ...
  { value: 620000, label: '甘肃', children: [
    ...
    { value: 622900, label: '临夏', children: [
    ...
    { value: 623000, label: '甘南', children: [
  ...
  { value: 630000, label: '青海', children: [
    ...
    { value: 632600, label: '果洛', children: [
    ...
    { value: 632700, label: '玉树', children: [
      { value: 632701, label: '玉树县' },
    ...
    { value: 632800, label: '海西', children: [
  ...
  { value: 650000, label: '新疆', children: [
    ...
    { value: 652900, label: '阿克苏地区', children: [
    ...
    { value: 654000, label: '伊犁哈萨克', children: [
    ...
    { value: 654300, label: '阿勒泰地区', children: [
    ...
    { value: 659001, label: '石河子市', children: [] },
    { value: 659002, label: '阿拉尔市', children: [] },
    { value: 659003, label: '图木舒克市', children: [] },
    { value: 659004, label: '五家渠市', children: [] },
    { value: 659006, label: '铁门关市', children: [] }
  ] },
